...
This folder is what the public Vercel project deploys. `/` and `/en` / `/fr` are the patient landing page; `/studio` is the private Ads Studio.
...
# Edit .env.local — at minimum set STUDIO_PASSWORD for /studio
npm run dev
```

- Landing: [http://localhost:3000/en](http://localhost:3000/en)
